...
describe PagesController do
  ...
  let(:valid_attributes) { { "name_file" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved page as @page" do
        ...
        post :create, {:page => { "name_file" => "invalid value" }}, valid_session
        assigns(:page).should be_a_new(Page)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested page" do
        ...
        Page.any_instance.should_receive(:update).with({ "name_file" => "MyString" })
        put :update, {:id => page.to_param, :page => { "name_file" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the page as @page" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Page.any_instance.stub(:save).and_return(false)
        put :update, {:id => page.to_param, :page => { "name_file" => "invalid value" }}, valid_session
        assigns(:page).should eq(page)
      end
